...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        ...
        resume.setContact(ContactType.LINKEDIN, "ссылка");
        resume.setContact(ContactType.GITHUB, "ссылка");
        resume.setContact(ContactType.STACKOVERFLOW, "ссылка");
        resume.setContact(ContactType.HOMEPAGE, "ссылка");

        resume.setSection(SectionType.OBJECTIVE, new TextSection("Ведущий стажировок и корпоративного обучения " +
                "по Java Web и Enterprise технологиям"));
        resume.setSection(SectionType.PERSONAL, new TextSection("Аналитический склад ума, сильная логика, креативность, " +
